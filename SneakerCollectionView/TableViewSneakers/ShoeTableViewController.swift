...
class ShoeTableViewController: UIViewController, UITableViewDelegate {

    
    @IBOutlet weak var SneakerTableView: UITableView!
    
    
    let imageViewShit = UIImageView()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        info.myimage = imageToBeSent
        //print(imageToBeSent)
        info.myString = sneakerToBeSent
